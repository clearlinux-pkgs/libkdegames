...
Version  : 22.08.2
Release  : 45
URL      : https://download.kde.org/stable/release-service/22.08.2/src/libkdegames-22.08.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.08.2/src/libkdegames-22.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.2/src/libkdegames-22.08.2.tar.xz.sig
...
%prep
%setup -q -n libkdegames-22.08.2
cd %{_builddir}/libkdegames-22.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665705877
mkdir -p clr-build
pushd clr-build
