...
Version  : 24.08.2
Release  : 76
URL      : https://download.kde.org/stable/release-service/24.08.2/src/libkdegames-24.08.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.08.2/src/libkdegames-24.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.2/src/libkdegames-24.08.2.tar.xz.sig
...
%setup -q -n libkdegames-24.08.2
cd %{_builddir}/libkdegames-24.08.2
pushd ..
cp -a libkdegames-24.08.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728577978
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKDEGames6.so.6.0.240802
/V3/usr/lib64/libKDEGames6Private.so.6.0.240802
/V3/usr/lib64/qt6/qml/org/kde/games/core/libcorebindingsplugin.so
/usr/lib64/libKDEGames6.so.6
/usr/lib64/libKDEGames6.so.6.0.240802
/usr/lib64/libKDEGames6Private.so.6
/usr/lib64/libKDEGames6Private.so.6.0.240802
