...
Source0  : https://download.kde.org/stable/release-service/24.02.0/src/libkdegames-24.02.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.0/src/libkdegames-24.02.0.tar.xz.sig
...
%prep
%setup -q -n libkdegames-24.02.0
cd %{_builddir}/libkdegames-24.02.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709320554
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKDEGames6.so.6.0.240200
/V3/usr/lib64/libKDEGames6Private.so.6.0.240200
/V3/usr/lib64/qt6/qml/org/kde/games/core/libcorebindingsplugin.so
/usr/lib64/libKDEGames6.so.6
/usr/lib64/libKDEGames6.so.6.0.240200
/usr/lib64/libKDEGames6Private.so.6
/usr/lib64/libKDEGames6Private.so.6.0.240200
