...
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/libkdegames-22.08.0.tar.xz
...
%prep
%setup -q -n libkdegames-22.08.0
cd %{_builddir}/libkdegames-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661534076
mkdir -p clr-build
pushd clr-build
