...
Source0  : https://download.kde.org/stable/release-service/22.12.2/src/libkdegames-22.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.2/src/libkdegames-22.12.2.tar.xz.sig
...
%prep
%setup -q -n libkdegames-22.12.2
cd %{_builddir}/libkdegames-22.12.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675639777
mkdir -p clr-build
pushd clr-build
