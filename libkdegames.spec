...
%setup -q -n libkdegames-24.05.0
cd %{_builddir}/libkdegames-24.05.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716481894
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKDEGames6.so.6.0.240500
/V3/usr/lib64/libKDEGames6Private.so.6.0.240500
/V3/usr/lib64/qt6/qml/org/kde/games/core/libcorebindingsplugin.so
/usr/lib64/libKDEGames6.so.6
/usr/lib64/libKDEGames6.so.6.0.240500
/usr/lib64/libKDEGames6Private.so.6
/usr/lib64/libKDEGames6Private.so.6.0.240500
