...
Source0  : https://download.kde.org/stable/release-service/23.08.3/src/libkdegames-23.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.3/src/libkdegames-23.08.3.tar.xz.sig
...
%prep
%setup -q -n libkdegames-23.08.3
cd %{_builddir}/libkdegames-23.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702016647
mkdir -p clr-build
pushd clr-build
