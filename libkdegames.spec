...
Source0  : https://download.kde.org/stable/release-service/25.04.2/src/libkdegames-25.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.2/src/libkdegames-25.04.2.tar.xz.sig
...
%setup -q -n libkdegames-25.04.2
cd %{_builddir}/libkdegames-25.04.2
pushd ..
cp -a libkdegames-25.04.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749488196
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKDEGames6.so.6.0.250402
/V3/usr/lib64/libKDEGames6Private.so.6.0.250402
/V3/usr/lib64/qt6/qml/org/kde/games/core/libcorebindingsplugin.so
/usr/lib64/libKDEGames6.so.6
/usr/lib64/libKDEGames6.so.6.0.250402
/usr/lib64/libKDEGames6Private.so.6
/usr/lib64/libKDEGames6Private.so.6.0.250402
