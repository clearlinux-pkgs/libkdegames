...
Source0  : https://download.kde.org/stable/release-service/21.12.2/src/libkdegames-21.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.12.2/src/libkdegames-21.12.2.tar.xz.sig
...
%prep
%setup -q -n libkdegames-21.12.2
cd %{_builddir}/libkdegames-21.12.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643998524
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libkdegames-21.12.2/LICENSES/BSD-2-Clause.txt %{buildroot}/usr/share/package-licenses/libkdegames/52039e5c19c950d4c7d6ec5da42ebba2c6def7ee
cp %{_builddir}/libkdegames-21.12.2/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/libkdegames/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/libkdegames-21.12.2/LICENSES/GFDL-1.2-or-later.txt %{buildroot}/usr/share/package-licenses/libkdegames/7697008f58568e61e7598e796eafc2a997503fde
cp %{_builddir}/libkdegames-21.12.2/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/libkdegames/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/libkdegames-21.12.2/LICENSES/ICS.txt %{buildroot}/usr/share/package-licenses/libkdegames/221e6be04f1b020e012e7bd9e9e39b86fda17ba2
cp %{_builddir}/libkdegames-21.12.2/LICENSES/LGPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/libkdegames/a4c60b3fefda228cd7439d3565df043192fef137
cp %{_builddir}/libkdegames-21.12.2/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/libkdegames/a4c60b3fefda228cd7439d3565df043192fef137
cp %{_builddir}/libkdegames-21.12.2/src/carddecks/svg-konqi-modern/COPYRIGHT %{buildroot}/usr/share/package-licenses/libkdegames/5573560dd763dfa71382a7b14fc7016fe877f9b9
cp %{_builddir}/libkdegames-21.12.2/src/carddecks/svg-standard/COPYRIGHT %{buildroot}/usr/share/package-licenses/libkdegames/8d92c816e421da0e573f208ff54beab223dc2de4
cp %{_builddir}/libkdegames-21.12.2/src/carddecks/svg-tigullio-international/COPYRIGHT %{buildroot}/usr/share/package-licenses/libkdegames/0525f48093a421a78d3524e598e8fee0cb5d4886
cp %{_builddir}/libkdegames-21.12.2/src/carddecks/svg-xskat-french/COPYRIGHT %{buildroot}/usr/share/package-licenses/libkdegames/33f6ef5ae6fc21b42ca7d9d1aeb7390aca7366af
cp %{_builddir}/libkdegames-21.12.2/src/carddecks/svg-xskat-german/COPYRIGHT %{buildroot}/usr/share/package-licenses/libkdegames/f2324384bebcce4eaf3d153583f0eb2caf6960a0
pushd clr-build
%make_install
popd
