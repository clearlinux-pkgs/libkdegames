...
Source0  : https://download.kde.org/stable/release-service/24.12.3/src/libkdegames-24.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.3/src/libkdegames-24.12.3.tar.xz.sig
...
%setup -q -n libkdegames-24.12.3
cd %{_builddir}/libkdegames-24.12.3
pushd ..
cp -a libkdegames-24.12.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742429250
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKDEGames6.so.6.0.241203
/V3/usr/lib64/libKDEGames6Private.so.6.0.241203
/V3/usr/lib64/qt6/qml/org/kde/games/core/libcorebindingsplugin.so
/usr/lib64/libKDEGames6.so.6
/usr/lib64/libKDEGames6.so.6.0.241203
/usr/lib64/libKDEGames6Private.so.6
/usr/lib64/libKDEGames6Private.so.6.0.241203
